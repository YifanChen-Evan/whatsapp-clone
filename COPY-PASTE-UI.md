# Create a new folder named "whatsapp-clone"
...
-   create a new terminal and then type the command

```bash
npx shadcn-ui@latest init
```

# Update app/global.css file
...
-   delete all the code and then paste the following code
...
-   Create components/home/theme-switch.tsx
...
-   And create home/conversation.tsx
...
# 如果Tab的图标不显示，just do a hard reload: command+shift+R
