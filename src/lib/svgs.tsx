// MessageSeenSvg 是一个 React 组件，渲染了一个 SVG 图标，用于表示消息已读状态

// 导出名为 MessageSeenSvg 的函数组件，接受 React.SVGProps<SVGSVGElement> 类型的 props
export const MessageSeenSvg = (props: React.SVGProps<SVGSVGElement>) => (
	<svg width={16} height={11} fill='none' {...props}>
		<title>{"msg-dblcheck"}</title> {/* 为 SVG 元素添加标题。用于辅助技术（如屏幕阅读器），可以为 SVG 图像提供描述 */}
		<path
			fill='currentColor'
